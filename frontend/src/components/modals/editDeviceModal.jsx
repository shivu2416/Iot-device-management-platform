const EditDeviceModal = ({ setDeviceModal, fetchDeviceById, device, setDevice, users, handleEditDevice, deviceId }) => {
    return (
        <div style={{
            display: "flex",
            alignItems: "center",
            ...
            >
                <div className="relative p-4 w-full max-w-md max-h-full">
                    ...
                    block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            ...
                            <div class="flex items-center mt-2">
                                <input
                                    ...
                                    onChange={(event) =>
                                        setDevice({ ...device, is_active: event.target.checked })
                                    }
                   ...
                   focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                            ...
                            <button onClick={() => handleEditDevice()} className="w-full mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Save
                            </button>
                        </div>
                    </div>
